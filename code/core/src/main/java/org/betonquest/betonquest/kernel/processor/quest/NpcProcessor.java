...
public class NpcProcessor extends TypedQuestProcessor<NpcIdentifier, NpcWrapper<?>> {
    ...
    /**
     * The {@link IdentifierFactory} to create {@link ConversationID}s.
     */
     ...
     * @param conversationIdentifierFactory the identifier factory to create {@link ConversationID}s for this type
    ...
    public NpcProcessor(final BetonQuestLogger log, final BetonQuestLoggerFactory loggerFactory,
        ...
        super(log, placeholders, packManager, npcTypes, npcIdentifierFactory, "Npc", "npcs");
